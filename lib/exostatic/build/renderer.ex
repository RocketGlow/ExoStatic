defmodule Exostatic.Build.Renderer do
  ...
  def genpage(contents, ctx) do
    ...
    base = Exostatic.get_data("template_base")
    contents = process_links(contents, proj)
    render(base, proj ++ ctx ++ [contents: contents, navigation: Exostatic.get_data(:navstub)])
  end
